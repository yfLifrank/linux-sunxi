...
static struct sun4i_a10_display_clk_data sun5i_r8_tcon_ch0_data = {
	.has_rst	= true,
	.parents	= 4,
	.offset_en	= 31,
	.offset_rst	= 29,
...
static void __init sun5i_r8_tcon_ch0_setup(struct device_node *node)
{
	sun4i_a10_display_init(node, &sun5i_r8_tcon_ch0_data);
}
CLK_OF_DECLARE(sun5i_r8_tcon_ch0, "allwinner,sun5i-r8-tcon-ch0-clk",
	       sun5i_r8_tcon_ch0_setup);
