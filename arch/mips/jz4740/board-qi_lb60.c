...
/* NAND */
NAND_ECCLAYOUT(qi_lb60_ecclayout_1gb,
	       NAND_ECCLAYOUT_ECCPOS(6, 7, 8, 9, 10, 11, 12, 13,
...
NAND_ECCLAYOUT(qi_lb60_ecclayout_2gb,
	       NAND_ECCLAYOUT_ECCPOS(12, 13, 14, 15, 16, 17, 18, 19,
	       ...
	       NAND_ECCLAYOUT_OOBFREE(NAND_OOBFREE(2, 10),
				      NAND_OOBFREE(84, 44)));
