...
NAND_ECCLAYOUT(akita_oobinfo,
	       NAND_ECCLAYOUT_ECCPOS(0x05, 0x01, 0x02, 0x03, 0x06, 0x07,
				     0x15, 0x11, 0x12, 0x13, 0x16, 0x17,
				     0x25, 0x21, 0x22, 0x23, 0x26, 0x27,
				     0x35, 0x31, 0x32, 0x33, 0x36, 0x37),
	       NAND_ECCLAYOUT_OOBFREE(NAND_OOBFREE(8, 9)));
